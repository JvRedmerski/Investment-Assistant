...
- **Status**: 🟡 EVENTS IN_PROGRESS — **2 de 3 tasks entregues**: EVENTS-001 (distribuições por exercício, da DMPL da CVM — fechou o `dy`) e EVENTS-002 (data e natureza do evento societário, pelo arquivo de fim de dia da B3). Falta **EVENTS-003**, a série de retorno total, que é o que destrava o pilar de Risco. A wave **PRICE** (3 tasks) fechou antes, em 2026-08-19
...
- [ ] **EVENTS-003**: Série de retorno total — a **magnitude** dos eventos e o `adjusted_close` derivado dela ⚪ NOT_STARTED
...
Definition of Done da wave EVENTS: **ainda não atendida** — falta a EVENTS-003. `dy` e a data dos eventos existem; a **magnitude** e a série de retorno total, não. O pilar de Risco segue ausente e a cobertura do score segue em 0,75.
