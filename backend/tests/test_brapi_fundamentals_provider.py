...
def _full_payload():
    return _payload(
        ...
        balance_rows=[
            {
                "endDate": "2024-12-31",
                "totalStockholderEquity": 350_000_000_000,
                "cash": 60_000_000_000,
                "totalDebt": 300_000_000_000,
            },
            {
                "endDate": "2023-12-31",
                "totalStockholderEquity": 340_000_000_000,
                "cash": 70_000_000_000,
                "shortLongTermDebt": 40_000_000_000,
...
def test_debt_falls_back_to_sum_of_short_and_long_term_components():
    provider = _provider(_static(_full_payload()))
