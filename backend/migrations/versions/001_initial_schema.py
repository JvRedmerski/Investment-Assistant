...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "risk_profile",
            sa.Enum("CONSERVATIVE", "MODERATE", "AGGRESSIVE", name="riskprofileenum"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_investor_profiles_id"), "investor_profiles", ["id"], unique=False
    )
    ...
    op.create_index(
        "idx_asset_price_date", "asset_prices", ["asset_id", "date"], unique=False
    )
    ...
    op.create_index(
        "idx_intraday_asset_timestamp",
        "intraday_prices",
        ["asset_id", "timestamp"],
        unique=False,
    )
    op.create_index(
        op.f("ix_intraday_prices_id"), "intraday_prices", ["id"], unique=False
    )
    ...
    op.create_index(
        "idx_transactions_portfolio_asset",
        "transactions",
    ...
    op.create_index(
        "idx_fundamentals_asset_refdate",
        "fundamentals",
    ...
    op.create_index(
        op.f("ix_daytrade_setups_id"), "daytrade_setups", ["id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column("created_at", sa.DateTime(), nullable=False),
        sa.ForeignKeyConstraint(
            ["setup_id"], ["daytrade_setups.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint("setup_id"),
    )
    op.create_index(
        op.f("ix_daytrade_results_id"), "daytrade_results", ["id"], unique=False
    )
